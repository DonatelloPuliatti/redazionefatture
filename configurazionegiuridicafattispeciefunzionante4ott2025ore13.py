    ...
    if request.method == "POST":
        ...
        if request.form.get("form_id") == "conversione":
            ...
            PROMPT = """Per ciascun periodo del testo estrai le formule logiche nella forma "P1, P2.., Pn -> E1, E2..., En".
                        ...
                        - Il numero di presupposti (P1…Pn) ed effetti (E1…Em) NON ha limiti.
                        - Usa congiunzione, disgiunzione, negazione (simboli: &, |, ¬, -> oppure AND, OR, NOT, ->).
                        - Analizza TUTTI i periodi, anche se definitori.
                        - Mantieni coerenza tra variabili nelle formule e nel dizionario.
                        - Definizioni P*/E* massimamente dettagliate e granulari.
                        - Considera che i periodi successivi possono introdurre deroghe.
