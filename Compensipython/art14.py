...
def art14():
    ...
    primoscaglione = [0, 5164.57, 1.4053, 2.8106]
    secondoscaglione = [5164.58, 10329.14, 0.9316, 1.8790]
    terzoscaglione = [10329.15, 25822.84, 0.4737, 0.9474]
    quartoscaglione = [25822.85, 51645.69, 0.2842, 0.5684]
    quintoscaglione = [51645.70, 103291.38, 0.1879, 0.3758]
    sestoscaglione = [103291.39, 258228.45, 0.0932, 0.1879]
    ...
    if risultato < 145.12:
        risultatoformattato = "145.12, in quanto ai sensi dell'ultimo comma dell'art. 14, il compenso non può essere inferiore a tale importo"
    if importo > settimoscaglione[1]:
        risultatoformattato = f"{risultatoformattato}, ovvero il compenso da corrispondere quando l'importo stimato è pari ad € 516.456.90. Si tenga presente che nel D.M. non è previsto uno scaglione finale con valore illimitato"
...
"""
    ...
    ipotesiselezionata = "La fattispecie selezionata è la 'perizia o la consulenza in materia di cave e miniere, minerali, sostanze solide, liquide e gassose ', disciplinata dall'art. 14 D.M. 30 maggio 2002"
    if compenso == 0:
