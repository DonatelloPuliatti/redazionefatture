...
def art3():
    ...
    for idx, i in enumerate(listascaglioni):
        if importo > i[0]:
            ...
            risultatoperscaglione = (percentualedaapplicare / 100 * sommariferimento)/2
...
La fattispecie selezionata è la 'perizia o la consulenza tecnica in materia di valutazione di aziende, enti patrimoniali, situazioni aziendali, patrimoni, avviamento, diritti a titolo di risarcimento di danni, diritti aziendali e industriali nonchè relativi a beni mobili in genere', disciplinata dall'art. 3 D.M. 30 maggio 2002.
"""
    if compenso == 0:
        tipologiacompenso = """
