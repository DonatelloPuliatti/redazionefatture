...
def borsa():
    ...
    if tipologia == "BTP":
        ...
        colonne_da_esportare = ['ISIN', 'Nome', 'Prezzo', 'Cedola %', 'Scadenza', 'Cedola annuale %',
                                'Rendimento attuale %', 'Numero cedole', 'Ricavo totale', 'Guadagno totale lordo',
                                'Guadagno totale netto', 'Guadagno medio lordo', 'Guadagno medio netto']
        ...
        tabella_html = df.to_html(classes="tabella-risultati display nowrap", table_id="btpTable", index=False)
